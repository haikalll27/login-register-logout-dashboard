                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="../auth/process_login.php" method="post">
                                        <div class="form-group mb-2">
                                            <label for="email" class="ms-lg-3">Email</label>
                                        ...
                                        <div class="form-group mb-4">
                                            <label for="password" class="ms-lg-3">Password</label>
                                            <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Password" required>
                                        </div>
                                        <button type="submit" class="btn btn-primary-cs btn-user btn-block">Login</button>
                                    </form>
                                    <hr>
                                    <div class="text-center">
